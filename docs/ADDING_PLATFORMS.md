...
|------|-----------|----------|------|------|------|------|
| **QQ 官方机器人** | ✅ 官方开放平台 | WebSocket / Webhook 事件网关 + REST API | 图片/语音/富媒体（需素材上传接口） | 中 | 低（官方合规） | ⭐ 首选。有频道(guild)、群、单聊三种场景，需区分 |
| **飞书 / Lark** | ✅ 官方开放平台 | 事件订阅(长连接/Webhook) + 消息 API | 图片/文件/富文本卡片 | 中 | 低 | ⭐ 推荐。企业场景清晰、文档完善 |
